...
# Configure CORS
# Set to False for security, only allow specified origins
...
MIDDLEWARE = [
    ...
    'authentication.exceptions.DisableCSRFMiddleware',
...
CACHES = {
    'default': {
        ...
        'LOCATION': 'redis://127.0.0.1:6379/1',  # Connect to your Redis server
        'OPTIONS': {
